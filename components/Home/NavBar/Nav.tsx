...
return () => {
  ...
  return (
    <div className={`fixed ${navBg ?'bg-gray-800' : ""} h-[10vh] z-[100] w-full transation-all duration-200`}>
        <div className='flex items-center h-full justify-between w-[95%] sm:w-[90%] xl:w-[80%] mx-auto'>
            ...
            <div className='flex items-center space-x-2'>
                ...
                <h1 className='font-bold text-white text-sm sm:text-base md:text-xl'>PrettyHomes RealEstate</h1>
            </div>
            {/* NavLinks*/}
