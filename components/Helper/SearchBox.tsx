...
const SearchBox = () => {
  return (
    ...
    <div className='flex items-center justify-between h-full'>
        <input type="text" 
        placeholder='Enter an address,city or zip to view the property'
        ...
        <div className='flex items-center flex-[0.2] ml-8 space-x-6'>
            ...
            <div className='w-12 h-12 bg-red-600 flex items-center hover:bg-red-800 transition-all duration-150 cursor-pointer justify-center text-white rounded-full'>
                <FaSearch />
